...
export const MENSAGENS_CLI_CORRECAO_TIPOS = {
  ...
  analiseDetalhadaSalva: `${ICONES_ARQUIVO.arquivo} Análise detalhada salva em: .sensei/fix-types-analise.json`,
  ...
  incertosMais: (qtd: number) => `  ... e mais ${qtd} casos incertos (veja .sensei/fix-types-analise.json)`,
